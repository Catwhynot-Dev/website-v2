(function () {
  ...
  const LABELS = {
    ...
    vertebraes: [
      ...
      "Thoracic superior articular facet",
    ...
    sacralc1c2: [
      "Occipital condyle articulation",
      "Axis articulation",
      "Transverse ligament",
  ...
  const COORDS_VERTEBRAES = {
    ...
    "Thoracic lamina": { x: 89.4298, y: 29.793 },
    "Thoracic pedicle": { x: 88.4562, y: 32.8431 },
    "Thoracic transverse process": { x: 48.9569, y: 36.0385 },
    "Thoracic superior articular facet": { x: 91.7246, y: 31.6812 },
  ...
  const COORDS_SACRALC1C2 = {
    "Occipital condyle articulation": { x: 48.7483, y: 49.6914 },
    "Axis articulation": { x: 71.0014, y: 27.0334 },
    "Transverse ligament": { x: 74.2698, y: 20.3522 },
    "Atlas vertebral foramen": { x: 48.5396, y: 49.8366 },
    "Anterior arch": { x: 48.8178, y: 49.6914 },
    "Posterior arch": { x: 48.9569, y: 49.9818 },
    "Atlas superior articular facet": { x: 48.6787, y: 49.6914 },
    "Atlas transverse foramen": { x: 48.6092, y: 49.6914 },
    "Dens": { x: 72.879, y: 18.0283 },
    "Axis vertebral body": { x: 48.4701, y: 48.8199 },
    "Axis spinous process": { x: 48.4701, y: 48.9651 },
    "Axis superior articular facet": { x: 48.5396, y: 49.1104 },
    ...
    "Posterior sacral foramina": { x: 49.235, y: 48.9651 },
    "Posterior coccyx": { x: 48.8178, y: 47.5127 },
    "Sacral base": { x: 94.1586, y: 51.5795 },
    "Sacral promontory": { x: 93.3241, y: 54.4844 },
    "Anterior sacral foramina": { x: 48.1919, y: 47.658 },
